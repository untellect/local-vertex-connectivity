...
namespace vertex_connectivity {
	...
	void unbalancedvc(const adjacency_list& G, resettable_graph& SG, size_t k, size_t min_vol, size_t max_vol, double sample_size_multiplier, vertex_set& cut, bool& found_cut);
	// Does G have a balanced vertex cut smaller than k?
	void balancedvc(const adjacency_list& G, resettable_graph& SG, size_t k, size_t repetitions, vertex_set& cut, bool& found_cut);
