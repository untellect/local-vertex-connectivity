...
namespace vertex_connectivity {
	...
	// Encapsulates the main part of the algorithm by Henzinger, Rao and Gabow
	class hrg
	{
		size_t n;
	...
	public:
		static void min_vc_split(const adjacency_list& G, size_t source, size_t k, vertex_set& cut, bool& found_cut);
	};
}
